    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('driver_rating', models.DecimalField(decimal_places=1, default=0.0, editable=False, max_digits=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_cargo_delivery', models.BooleanField(default=False)),
                ('service_area', models.JSONField(default=dict)),
                ('current_location', models.JSONField(default=dict)),
                ('driver', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='mover.driver')),
            ],
        ),
        migrations.CreateModel(
            name='Vehicle',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('license_plate', models.CharField(max_length=20, primary_key=True, serialize=False, unique=True)),
                ...
                ('service_status', models.CharField(choices=[('available', 'Available'), ('busy', 'Busy'), ('off_service', 'Off Service')], default='available', max_length=20)),
                ...
                ('driver', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='driver_vehicles', to='mover.driver')),
